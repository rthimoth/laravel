@if(session()->has('success'))
    <div x-data="{open: true}"
         ...
         x-transition:end="opacity-0" class="flex items-center p-2 mb-4 space-x-3 text-white bg-green-400">
...
@if(session()->has('error'))
    <div x-data="{open: true}"
         ...
         x-transition:start="opacity-1"
         x-transition:leave="transition duration-500 transform ease-in"
         x-transition:end="opacity-0" class="flex items-center p-2 mb-4 space-x-3 text-white bg-red-400">
