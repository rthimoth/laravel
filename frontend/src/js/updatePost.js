...
// Get the modal
const modalPost = document.getElementById("modal5")

const textArea = document.querySelector('#bodyPost');


// Get the <span> element that closes the modal
var spanPost = document.getElementById("closeModalUpdatePost");


// Get the button that opens the modal
const btnEditPost= document.getElementById("editPostButton")
